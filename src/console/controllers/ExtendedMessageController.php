 ...
 * What this does is find for all the uses of Yii::t and inserts a new entry in the database
 * for its translation. The command can be run the following way:
 * Console utility to extract Strings from the code and upload them to the DB.
 * <ul>
 * <li>You need to be inside a docker/ssh instance</li>
 * <li>Go to app/app/</li>
 * <li>First run: ./yii message/extract @common/config/messages/_base.php
 * <li>Run: ./yii message/migrate @common/config/messages/php.php @common/config/messages/db.php</li>
 * </ul>
