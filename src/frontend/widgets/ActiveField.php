...
class ActiveField extends \yii\widgets\ActiveField
{
    ...
    public function render($content = null)
    {
        ...
        if ($content === null)
        {
            ...
            {
                $input                    = isset($this->parts[ '{input}' ]) ? $this->parts[ '{input}' ] : Html::activeTextInput($this->model,
                    $this->attribute, $this->inputOptions);
    ...
    protected function renderLabelParts($label = null, $options = [ ])
    {
        ...
        if ($label === null)
        {
            ...
            else
            {
                ...
                if (ArrayHelper::remove($options, 'disabled', false))
                {
                    $label = '';
                }
                else
